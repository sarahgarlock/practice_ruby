...
# PLAN
# Nested Iteration
# if number is higher than next index then add 1 to that index position
# if number is lower than next index then add 1 to other index position
# if number is equal then skip  
